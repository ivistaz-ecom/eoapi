...
<head>
    ...
    <title>{{ config('app.name', 'EO Global') }}</title>
...
<body>
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('regions') }}">All Regions</a>
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('price-packs') }}">Price Packs</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('registration-count') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Registration Count</span></a>
            </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <!-- Topbar Search -->
            <form method="get" action="{{ route('search-result') }}" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                @csrf
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>&copy; EO Global @php echo date('Y'); @endphp</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
